<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Data_Penyewa.aspx.cs" Inherits="Kost_Q.src.Data_Penyewa" %>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="container mt-5 pt-5">
                <div class="table-responsive">
                    <table class="table table-hover table-borderless align-middle text-center fs-5" style="background-color: rgb(255, 239, 208);">
                        <thead style="border-bottom: 2px solid black;">
                            <tr>
                                <th scope="col" class="py-3">Nama</th>
                                <th scope="col" class="py-3">Tanggal Masuk</th>
    ...
    <div class="tambah-data" style="position: absolute; bottom: 3rem; right: 5rem; border-radius: 50%;">
        <a href="Tambah_Data_Penyewa.aspx" class="btn btn-warning" style="width: 80px; height: 80px; border-radius: 50%;">
