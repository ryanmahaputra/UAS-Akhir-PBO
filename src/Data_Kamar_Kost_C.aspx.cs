...
{
    public partial class Data_Kamar_Kost : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                using (NpgsqlConnection connection = new NpgsqlConnection())
                {
                    ...
                    cmd.CommandText = "SELECT * FROM kamar WHERE status = 'Kosong';";
                    ...
                    for(int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        sb.Append("<a href='Detail_Kamar_Customer.aspx?i=" + dt.Rows[i][0] + "' class='btn btn-info btn-sm' style='color: black;'>");
                        sb.Append("Detail");
                        sb.Append("</a>");
                        sb.Append("</td>");
                        sb.Append("</tr>");
                    ...
                    info_data_kost_c.Controls.Add(new LiteralControl(sb.ToString()));
        ...
        protected void keluar_C_Click(object sender, EventArgs e)
        {
            Session["admin"] = null;
