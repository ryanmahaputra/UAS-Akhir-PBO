...
{
    public partial class Laporan_Keuangan : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                using (NpgsqlConnection connection = new NpgsqlConnection())
                {
                    ...
                    cmd.CommandText = "SELECT * from laporan_keuangan ORDER BY id_laporan_keuangan ASC;";
                    ...
                    sb.Append("<tr>");
                    sb.Append("<th scope='col' class='py-3'>Produk</th>");
                    sb.Append("<th scope='col' class='py-3'>Tanggal</th>");
                    sb.Append("<th scope='col' class='py-3'>Keuntungan</th>");
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        sb.Append("<a href='Laporan_Keuangan_Detail.aspx?id=" + dt.Rows[i][0] + "' class='btn btn-info btn-sm' style='color: black;'>");
                        sb.Append("Detail");
                        sb.Append("</a>");
                        sb.Append("</td>");
                        sb.Append("</tr>");
                    ...
                    laporan_uang.Controls.Add(new LiteralControl(sb.ToString()));
