<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ubah_Laporan_Keuangan.aspx.cs" Inherits="Kost_Q.src.Ubah_Laporan_Keuangan" %>
        ...
        <div class="container-fluid mt-5 pt-5">
            <div class="container">
                <div class="judul mb-5">
                    <h1 class="text-center">Ubah Laporan Keuangan</h1>
                </div>
                <div class="akses w-75 mx-auto row">
                    <div class="col-11">
                        ...
                        <div class="tbl-login text-center mb-5">
                            <asp:Button Text="SUBMIT" ID="ubah_keuangan" CssClass="btn btn-warning fs-5" runat="server" OnClick="tbl_ubah_keuangan_Click" />
                        </div>
                    </div>
                    <div class="col-1">
