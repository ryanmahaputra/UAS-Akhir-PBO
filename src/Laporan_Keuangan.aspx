<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Laporan_Keuangan.aspx.cs" Inherits="Kost_Q.src.Laporan_Keuangan" %>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="container mt-5 pt-5">
                <div class="table-responsive">
                    <asp:PlaceHolder ID="laporan_uang" runat="server"></asp:PlaceHolder>
                </div>
            </div>
    ...
    <div class="tambah-data" style="position: absolute; bottom: 3rem; right: 5rem; border-radius: 50%;">
        <a href="Tambah_Laporan_Keuangan.aspx" class="btn btn-warning" style="width: 80px; height: 80px; border-radius: 50%;">
